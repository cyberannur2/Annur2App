...
import com.miniawradsantri.awrad.databinding.FragmentBacaanTabLayoutCounterBinding

class BacaanTabLayoutCounterFragment : Fragment() {

    private lateinit var binding: FragmentBacaanTabLayoutCounterBinding
    ...
    companion object {
        fun newInstance(title: String, tabTitles: List<String>): BacaanTabLayoutCounterFragment {
            val fragment = BacaanTabLayoutCounterFragment()
            val args = Bundle()
    ...
    override fun onCreateView(
        ...
        binding = FragmentBacaanTabLayoutCounterBinding.inflate(inflater, container, false)
        return binding.root
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        parentFragmentManager.setFragmentResultListener("requestKey", this) { _, bundle ->
            ...
            Log.d("BacaanTabLayoutCounterFragment", "New text size received: $newTextSize")
            ...
            for (i in 0 until fragmentAdapter.itemCount) {
                ...
                Log.d("BacaanTabLayoutCounterFragment", "Looking for fragment with tag: f$i")
        ...
        binding.btnEditText.setOnClickListener {
            parentFragmentManager.beginTransaction()
                .replace(R.id.fragment_bacaan_tab_layout_counter, EditTextSize())
                .addToBackStack(null)
                .commit()
        }
    ...
    private fun getSharedPreferences(): SharedPreferences {
        return requireActivity().getSharedPreferences("Counter_Preferences", Context.MODE_PRIVATE)
    }
    private fun saveCounterValue(value: Int) {
    ...
    private fun loadCounterValue(): Int {
        val sharedPreferences = getSharedPreferences()
        return sharedPreferences.getInt("COUNTER_VALUE", 0)// ini default value nya
    }
